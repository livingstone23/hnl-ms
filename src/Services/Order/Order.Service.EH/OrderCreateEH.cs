...
using Order.Service.EH.Commands;
...
{
    public class OrderCreateEH : INotificationHandler<OrderCreateCommand>
    {
        private readonly ApplicationDbContext _context;
        private readonly ICatalogProxy _catalogProxy;
        private readonly ILogger<OrderCreateEH> _logger;


        public OrderCreateEH(ApplicationDbContext context, ICatalogProxy catalogProxy, ILogger<OrderCreateEH> logger)
        {
            _context = context;
