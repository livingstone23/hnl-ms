...
{
    public class ProductInStockUpdateStockEH :   INotificationHandler<ProductInStockUpdateStockCommand>
    {

        private readonly ApplicationDbContext _context;
        private readonly ILogger<ProductInStockUpdateStockEH> _logger;

        public ProductInStockUpdateStockEH(
            ApplicationDbContext context,
            ILogger<ProductInStockUpdateStockEH> logger
            )
        {
            _context = context;
            _logger = logger;
